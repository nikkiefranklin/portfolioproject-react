...
import { Card, CardImg, CardText, CardBody, CardTitle, UncontrolledCollapse } from 'reactstrap';
              ...
              <div className="col">
                <div id="accordion">
                  <Card className="card" id="git">
                    <CardBody>
                      <CardTitle tag="h4" className="font-weight-bold text-danger" data-toggle="collapse" data-target="#bootstrap">
                        Getting Started  <small>Why garden?</small></CardTitle>
                      <UncontrolledCollapse toggler="#git">
                  ...
                  <Card className="card" id="sweetB">
                    <CardBody>
                      ...
                      <UncontrolledCollapse toggler="#sweetB">
                  ...
                  <Card className="card" id="sweetO">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#sweetOnion">Sweet Onion
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#sweetO">
                  ...
                  <Card className="card" id="nicolaP">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#nicolaOnion">Nicola Potato
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#nicolaP">
                  ...
                  <Card className="card" id="blueB">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#bbHedge">Blueberry Hedge
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#blueB">
                  ...
                  <Card className="card" id="beastS">
                    <CardBody role="tab" className="card-header">
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#bstrawberry">Beast Strawberry
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#beastS">
                  ...
                  <Card className="card" id="billieB">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#bBlackberry">Billie's Blackberry
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#billieB">
                  ...
                  <Card className="card" id="sugarS">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#sWatermelon">Sugar Sweet Watermelon
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#sugarS">
                  ...
                  <Card className="card" id="monsterT">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#monsterToe">Monster Tomatoe
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#monsterT">
                  ...
                  <Card className="card" id="gmaC">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#gmaCuke">Grandma's Cucumber
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#gmaC">
                  ...
                  <Card className="card" id="bushB">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#bbSeed">Bush Bean Seed
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#bushB">
                  ...
                  <Card className="card" id="queenE">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#queenEggplant">Queen Eggplant
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#queenE">
                  ...
                  <Card className="card mb-5" id="frankenP">
                    <CardBody>
                      <CardTitle tag="h4" className="collapsed font-weight-bold text-danger" data-toggle="collapse" data-target="#frankenPum">Franken-Pumpkin
                          <small>  Planting Instructions</small></CardTitle>
                      <UncontrolledCollapse toggler="#frankenP">
